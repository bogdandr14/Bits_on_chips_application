...
{
    public class ShipmentMethodRepository : RepositoryBase<ShipmentMethod>, IShipmentMethodRepository
    {
        public ShipmentMethodRepository(BitsOnChipsDbContext repositoryContext)
